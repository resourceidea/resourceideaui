...
echo "dotnet run --project src/dev/Infrastructure/EastSeat.ResourceIdea.Migration/EastSeat.ResourceIdea.Migration.csproj -- migrate-all"

# Example: Migrate specific table
echo "To migrate a specific table, run:"
echo "dotnet run --project src/dev/Infrastructure/EastSeat.ResourceIdea.Migration/EastSeat.ResourceIdea.Migration.csproj -- migrate-table \"TableName\""
